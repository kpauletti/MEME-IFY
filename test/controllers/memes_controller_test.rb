...
class MemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meme" do
    assert_difference('Meme.count') do
      post memes_url, params: { meme: { description: @meme.description, image: @meme.image, name: @meme.name } }
    end
  ...
  test "should update meme" do
    patch meme_url(@meme), params: { meme: { description: @meme.description, image: @meme.image, name: @meme.name } }
